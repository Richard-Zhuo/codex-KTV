...
VALUES
  ...
  ('room.issue', '标记房间故障／维护及提交恢复申请', '房间与订单'),
  ('room.issue.approve', '审核房间恢复申请', '审核与后台'),
...
VALUES
  ...
  ('owner','credit.repay.approve'), ('owner','gift.approve'), ('owner','inventory.opening'), ('owner','inventory.adjust'), ('owner','inventory.approve'), ('owner','deposit.manage'), ('owner','handover'),
  ('owner','expense.view'), ('owner','expense.create'), ('owner','expense.viewAll'), ('owner','expense.approve'),
  ('owner','procurement.create'), ('owner','procurement.viewAll'), ('owner','incident.create'), ('owner','incident.viewAll'), ('owner','incident.resolve'), ('owner','incident.resolve.approve'),
  ...
  ('manager','credit.repay.approve'), ('manager','gift.approve'), ('manager','rounding.approve'), ('manager','inventory.opening'), ('manager','inventory.adjust'), ('manager','inventory.approve'), ('manager','handover'),
  ...
  ('manager','incident.create'), ('manager','incident.viewAll'), ('manager','incident.resolve'), ('manager','incident.resolve.approve'), ('manager','report.view'), ('manager','backend.view'),
  ...
  ('finance','credit.repay.approve'), ('finance','incident.viewAll'), ('finance','incident.resolve'), ('finance','incident.resolve.approve'), ('finance','report.view'), ('finance','backend.view'),
  ('procurement','inventory.opening'), ('procurement','inventory.adjust'), ('procurement','inventory.approve'), ('procurement','expense.view'), ('procurement','expense.create'),
